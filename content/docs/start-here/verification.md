...
If the build fails, continue to [Troubleshooting](/docs/start-here/troubleshooting/).
...
If your project includes optional integrations, validate those behaviors as well using the dedicated guides for [Thulite SEO](https://docs.thulite.io/seo/start-here/verification/), [Thulite Images](https://docs.thulite.io/images/start-here/verification/), and [Thulite SVG](https://docs.thulite.io/svg/start-here/verification/).
...
If anything looks incorrect, continue to [Troubleshooting](/docs/start-here/troubleshooting/).
