...
See [Commands](https://docs.thulite.io/thulite/reference/commands/) for full command details.
...
```bash
npm run create content docs/guides/another-example.md
```
...
```bash
pnpm run create content docs/guides/another-example.md
```
...
```bash
yarn run create content docs/guides/another-example.md
```
...
```bash
bun run create content docs/guides/another-example.md
```
...
- Follow the deployment guides in [Deployment overview](https://docs.thulite.io/thulite/basics/deployment/overview/).
- Use [Verification](/docs/start-here/verification/) to validate quality and output before production updates.
